...
<body>
    ...
    <div class="container-box">
        <div class="member">
            ...
            <div class="field">
                <b>비밀번호</b>
                <input class="userpw" type="password" placeholder= "비밀번호 입력 (문자,숫자 포함 8~20자)">
            </div>
            <div class="field">
                <b>비밀번호 재확인</b>
                <input class="userpw-confirm" type="password" placeholder= "비밀번호 재입력">
            </div>
            <div class="field">
                <b>이름</b>
            ...
            <div class="field birth">
                <b>생년월일</b>
                <div>
                    <input type="number" placeholder="연도(4자)">                
                    <select>
            ...
            <div class="field">
                ...
                <div class="email-input">
                    <input class="box" id="domain-txt" type="text" placeholder="이메일 입력"/>
