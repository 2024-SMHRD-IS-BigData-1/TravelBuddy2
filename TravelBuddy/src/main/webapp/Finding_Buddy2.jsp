				...
				<div class="chat_container">
					<div class="job-box">
						...
						<div class="text-center">
							<a href="post(write).jsp" class="btn btn-primary"
								style="background-color: gray;">게시글 작성</a>
						</div>
						<br>
						<br>
						<div class="w3-center w3-padding-32">
							<div class="w3-bar">
								...
								<a href="#page1" class="w3-bar-item w3-black w3-button">1</a> <a
									href="#page2" class="w3-bar-item w3-button w3-hover-black">2</a>
